...
## Phase 2. 유튜브 다운로드 및 AI 요약 1차 연동
...
- [ ] 음원 추출 기능 구현
- [ ] 자막 추출 가능 여부 확인
- [ ] n8n Webhook 호출 방식 정의
- [ ] 유튜브 자막 또는 추출 텍스트를 AI 요약으로 전달
- [ ] 요약 결과를 화면에 표시하거나 파일로 저장

완료 기준: 유튜브 URL 입력 후 자막 또는 텍스트 기반 AI 요약 결과를 받을 수 있다.
...
- [ ] PDF 문서 Q&A 기능 설계
- [ ] 이미지 설명 및 태깅 기능 추가
- [ ] OpenAI, Claude, Gemini 중 기본 LLM 제공자 선택
- [ ] LLM API 사용량 로그 저장
- [ ] API 오류, 속도 제한, 빈 응답 처리

완료 기준: 주요 추출 결과를 AI 기능으로 후처리할 수 있고, 실패 시 사용자가 원인을 알 수 있다.

## 운영 및 유지보수 작업

- [ ] 업로드 파일과 결과 파일 자동 삭제 스케줄 추가
- [ ] 로그 디렉터리와 보관 기간 정의
...
3. Phase 2: 유튜브 다운로드와 AI 요약 1개 기능 연결
4. Phase 3: 번역, Q&A, 이미지 설명 등 AI 기능 확장
