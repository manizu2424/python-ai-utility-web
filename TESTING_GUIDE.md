...
현재까지 구현된 Python AI Util 기능을 로컬에서 확인하는 방법입니다.
...
- PDF를 이미지 ZIP으로 변환
- PDF를 Word 문서로 변환 (텍스트만 옮기며 레이아웃·표·이미지는 유지되지 않음)
- PDF를 Excel 문서로 변환 (페이지·줄 단위 텍스트 목록)
- PDF 병합
- PDF 페이지 범위 분할
- PDF 압축
...
2026-09-25 기준 자동 테스트는 총 41개입니다.
